...
if ( is_home() ) {
	...
	<div id="chic-products"  class="boxed-wrapper clear-fix">
		<h2 class="chic-title">Dernières pièces </h2> <!-- modif: h1 par h2 -->
		<?php
	...
	<div id="chic-fashionweek-map" class="boxed-wrapper clear-fix" style="margin-top:30px">
		<h2 class="chic-title">La FashionMap - été 2022 </h2> <!-- modif: h1 par h2 -->
		<iframe loading="lazy" title="la carte google de la FashionMap"  src="https://www.google.com/maps/d/embed?mid=1SU-W19k76UkTXASeT7PnGAyDYCY&hl=en_US&ehbc=2E312F" width="100%" height="480"></iframe><!-- modif: ajout du title pour décrire le contenu de l'iframe + ajout de lazy loading -->
	</div>
	<?php
